        ...
        >
          {props.noIcon ? (
            <View style={{flex: 1, flexDirection: "row", justifyContent : "space-around", alignItems: "center"}}>
              <MaterialCommunityIcons name="arrow-left" size={30} color={isSwitchOn ? "white" : "black"}  onPress={props.backGoesto ? gotoHome :  gotoBack}/>
              <Text
                style={{
                  fontSize: 25,
                  color: isSwitchOn ? "white" : "black",
              ...
              <MaterialCommunityIcons color={isSwitchOn ? "white" : "black"} name="dots-vertical" size={30} />
            </View>
          ) : (
