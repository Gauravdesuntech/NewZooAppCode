...
const ListEggFertility = () => {
    ...
    const InnerList = ({ item }) => {
        const { fertility_id, description, created_at, code, string_id } = item.item
        return (
...

                {
                    isLoading || refreshing ? <Loader /> :
                        ...
                        <View style={styles.container}>
                            ...
                            <FlatList
                                data={eggFertility}
                                renderItem={item => <ListComponent item={item} onPressEdit={editFertility} onPressDelete={deleteFertility} onPress={() => navigation.navigate('GetEggFertility', { id: item.item.fertility_id })} >
                                    <InnerList item={item} />
                                </ListComponent>}
