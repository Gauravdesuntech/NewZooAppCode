        ...
        <View style={styles.innerContainer}>
          <View style={styles.column}>
            <View style={styles.row}>
              ...
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_id}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Name : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_first_name} {personalDetails.user_details.user_last_name}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Email : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_email}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Mobile Number : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_mobile_number}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Gender : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_gender}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Date of Birth : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_dob}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Blood Group : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_blood_grp}</Text>
            </View>
            <View style={styles.row}>
              <Text style={{ marginHorizontal: 5 }}>Marital Status : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_marital_status}</Text>
            </View>
            <View style={[styles.row,{borderBottomWidth: 0}]}>
              <Text style={{ marginHorizontal: 5 }}>Address : </Text>
              <Text style={{ marginHorizontal: 5 }}>{personalDetails.user_details.user_address}</Text>
            </View>
          </View>
        </View>
      )}
