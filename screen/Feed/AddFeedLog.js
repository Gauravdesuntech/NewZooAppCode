...
import { createFeedLog, getFeedBy, getFeedUOM } from '../../services/FeedService';
...
const AddFeedLog = (props) => {
    ...
    useEffect(() => {
        Promise.all([getFeedBy(),getFeedUOM()])
        .then((res) => {
            ...
            <CustomForm header={true} title={"Add Feed Log"} onPress={onSubmit}>
                ...
                <View>
                    <InputBox
                        ...
                        rightElement={quantity_UOM_DropDown ? "chevron-up" : "chevron-down"}
                ...
                <View>
                    <InputBox
                        ...
                        rightElement={feedingMethod_Dropdown ? "chevron-up" : "chevron-down"}
                ...
                <View>
                    <InputBox
                        ...
                        rightElement={fedByDropDown ? "chevron-up" : "chevron-down"}
                ...
                <Text style={{fontWeight:'600', color:'#2d2d2d'}}>Apply to all enclosures occupents?</Text> */}
                    <CheckBox title={"Apply to all enclosures occupents?"} onPress={onOccupent} checked={occupents} />
                </View>
